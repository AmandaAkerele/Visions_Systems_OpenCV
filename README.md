...
# Map INDICATOR_SUPPRESSION_CODE to missing_reason_code using the suppression_mapping
EDWT_Indicators['missing_reason_code'] = EDWT_Indicators['INDICATOR_SUPPRESSION_CODE'].map(suppression_mapping).fillna('')
