...
EDWT_Indicator_File['metric_descriptor_code'] = EDWT_Indicator_File['compare_code'].astype(str).replace(compare_mapping)
...
yr = '24'  # Assuming you have a variable 'yr' for the year
