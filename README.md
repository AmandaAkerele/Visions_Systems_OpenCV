...
# Drop rows where metric_descriptor_code is 999 for both PerformanceTrend and PerformanceComparison
...
EDWT_Indicator_File = EDWT_Indicator_File[~((EDWT_Indicator_File['metric_descriptor_code'] == '999') & (EDWT_Indicator_File['metric_descriptor_group_code'] == 'PerformanceComparison'))]
