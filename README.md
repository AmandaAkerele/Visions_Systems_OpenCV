...
# Change ORGANIZATION_ID for reporting_entity_code '1' to '80235'
TT_Spent_ED.loc[TT_Spent_ED['ORGANIZATION_ID'] == '1', 'ORGANIZATION_ID'] = '80235'
...
def generate_data_for_year(year, data):
    TT_Spent_ED_File = data[["FISCAL_YEAR_WH_ID", "ORGANIZATION_ID", "improvement_descriptor_code", "compare_descriptor_code", "missing_reason_code"]]
...
all_years_data = pd.concat([generate_data_for_year(year, TT_Spent_ED) for year in range(18, 23)])
...
# Change ORGANIZATION_ID for reporting_entity_code '1' to '80235' for Rows 1, 2, and 3
TT_Spent_ED.loc[TT_Spent_ED['ORGANIZATION_ID'].isin(['1', '2', '3']), 'ORGANIZATION_ID'] = '80235'
