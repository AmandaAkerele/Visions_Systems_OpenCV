...
tHE LOOP FOR # Loop through the last five years is  ot brinig accurate result. The results are inaccurate when i call df_nacrs[index]
...
#Main - Mineeeeeeee    
    ...
    tpia_org_22 = tpia_corp_alias.join(oi_alias, tpia_corp_alias['CORP_ID'] == oi_alias['org_id'], how='left')\
...
print("done")
# return output_df_2, intermediate_data_dict, tpia_supp_corp_combined
