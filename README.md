...
# Fill NaN values in 'metric_descriptor_code' with values from 'compare_code' mapped using compare_mapping
...
# Drop rows where 'metric_descriptor_code' is '999'
...
# Apply mapping to metric_descriptor_code and drop any value with 999
stacked_df['metric_descriptor_code'] = stacked_df['metric_descriptor_code'].map(improvement_mapping)
stacked_df['metric_descriptor_code'] = stacked_df['metric_descriptor_code'].map(compare_mapping)
stacked_df.drop(stacked_df[stacked_df['metric_descriptor_code'] == 999].index, inplace=True)
...
stacked_df['metric_descriptor_code'] = stacked_df['metric_descriptor_group_code'].map({
    'PerformanceTrend': stacked_df['improvement'],
    'PerformanceComparison': stacked_df['compare']
})

# Drop rows with '999' metric_descriptor_code
