this code does not accurately remove columns with FACILITY_AM_CARE_NUM .isin([54074,54075,54102,54168])) in the loop accurately. 
 ...
 # TPIA_site_Huron_Perth
        ...
        this is the entire code below with the loop: 
